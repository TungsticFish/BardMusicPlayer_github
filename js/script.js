...
const MusicList_Bard = [
    [''],//0-空的，下面开始是本职技能
    ['youcandoanything.mp3','wolaizhuni.mp3','justdoit.mp3','EVA.mp3','nibeiqianghuale.mp3'],//1-诗人激励
    ...
    ['kongyiji.mp3','ninengwoyeneng.mp3','xiaotougongsi.mp3'],//5-魔法奥秘
    ['zhugeliang.mp3','dinggong.mp3','wonengshuozanghuama.mp3']//6-恶毒嘲笑
    ] 
