...
function roll_ViciousMockery() {
    ...
    t_random = Math.floor(Math.random()*Vicious_Mockery_list_1.length)
    if (Vicious_Mockery_list_1.length = Vicious_Mockery_list_2.length) {
        result_ViciousMockery.innerHTML = '\u6076\u6bd2\u5632\u7b11\u53f0\u8bcd\u7075\u611f\uff1a '+ Vicious_Mockery_list_1[t_random] + "    #    " + Vicious_Mockery_list_2[t_random];
    } else {
        result_ViciousMockery.innerHTML = '\u6076\u6bd2\u5632\u7b11\u53f0\u8bcd\u7075\u611f\uff1a '+ Vicious_Mockery_list_1[t_random] //防止中英文不匹配
    }
    //振动效果
